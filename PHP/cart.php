...
<html>
	...
	<body>
		...
		?>
		<tr>
		<td><?php echo $values["name_article"]; ?></td>
		<td><?php echo $values["quantity_article"]; ?></td>
		<td>$ <?php echo $values["price_article"]; ?></td>
		<td>$ <?php echo number_format($values["quantity_article"] * $values["price_article"], 2);?></td>
		<td><a href="index.php?action=delete&id=<?php echo $values["id_article"]; ?>"><span class="text-danger">Remove</span></a></td>
		</tr>
		<?php
		$total = $total + ($values["quantity_article"] * $values["price_article"]);
		}
		?>
		<tr>
